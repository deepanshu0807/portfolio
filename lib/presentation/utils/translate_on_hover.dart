...
class _TranslateColorOnHoverState extends State<TranslateColorOnHover> {
  ...
  final hoverColor = AppColors.getPrimaryColor().withOpacity(0.2);
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: _hovering
                    ? AppColors.getPrimaryColor().withOpacity(0.4)
                    : Colors.transparent,
                width: 2),
            boxShadow: [
              BoxShadow(
...
class _TranslateMenuItemColorOnHoverState
  ...
  final nonHoverColor = Colors.transparent;
  final hoverColor = AppColors.getPrimaryColor().withOpacity(0.1);
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: _hovering
                    ? AppColors.getPrimaryColor().withOpacity(0.1)
                    : nonHoverColor,
                width: 1),
            boxShadow: [
              BoxShadow(
